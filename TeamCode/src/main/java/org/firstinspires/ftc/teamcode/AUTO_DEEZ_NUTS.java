...
@Config
@Autonomous(name = "AUTO_DEEZ_NUTS", group = "Autonomous")
public class AUTO_DEEZ_NUTS extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //traj go here
        TrajectoryActionBuilder path1 = drive.actionBuilder(new Pose2d(11.64, -63.24, Math.toRadians(90.00)))
